...
todaysworkout <- function(x, full = FALSE, upper = FALSE, lower = FALSE, core = FALSE, hard = FALSE, light = FALSE,  weights = FALSE) {
...
# Repeat workout generator code, rename it workoutsummary() 

workoutsummary <- function(x, full = FALSE, upper = FALSE, lower = FALSE, core = FALSE, hard = FALSE, light = FALSE,  weights = FALSE) {
...
summary.df[,1]<- unlist(lapply(seq_len(n), function(x) workoutsummary(upper = TRUE)))
summary.df[,2]<- unlist(lapply(seq_len(n), function(x) workoutsummary(upper = TRUE, hard = TRUE)))
summary.df[,3]<- unlist(lapply(seq_len(n), function(x) workoutsummary(upper = TRUE, light = TRUE)))
summary.df[,4]<- unlist(lapply(seq_len(n), function(x) workoutsummary(upper = TRUE, weights = TRUE)))
summary.df[,5]<- unlist(lapply(seq_len(n), function(x) workoutsummary(upper = TRUE, hard = TRUE, weights = TRUE)))
summary.df[,6]<- unlist(lapply(seq_len(n), function(x) workoutsummary(upper = TRUE, light = TRUE, weights = TRUE)))
summary.df[,7]<- unlist(lapply(seq_len(n), function(x) workoutsummary(lower = TRUE)))
summary.df[,8]<- unlist(lapply(seq_len(n), function(x) workoutsummary(lower = TRUE, hard = TRUE)))
summary.df[,9]<- unlist(lapply(seq_len(n), function(x) workoutsummary(lower = TRUE, light = TRUE)))
summary.df[,10]<- unlist(lapply(seq_len(n), function(x) workoutsummary(lower = TRUE, weights = TRUE)))
summary.df[,11]<- unlist(lapply(seq_len(n), function(x) workoutsummary(lower = TRUE, hard = TRUE, weights = TRUE)))
summary.df[,12]<- unlist(lapply(seq_len(n), function(x) workoutsummary(lower = TRUE, light = TRUE, weights = TRUE)))
summary.df[,13]<- unlist(lapply(seq_len(n), function(x) workoutsummary(core = TRUE)))
summary.df[,14]<- unlist(lapply(seq_len(n), function(x) workoutsummary(core = TRUE, hard = TRUE)))
summary.df[,15]<- unlist(lapply(seq_len(n), function(x) workoutsummary(core = TRUE, light = TRUE)))
summary.df[,16]<- unlist(lapply(seq_len(n), function(x) workoutsummary(core = TRUE, weights = TRUE)))
summary.df[,17]<- unlist(lapply(seq_len(n), function(x) workoutsummary(core = TRUE, hard = TRUE, weights = TRUE)))
summary.df[,18]<- unlist(lapply(seq_len(n), function(x) workoutsummary(core = TRUE, light = TRUE, weights = TRUE)))
summary.df[,19]<- unlist(lapply(seq_len(n), function(x) workoutsummary(full = TRUE)))
summary.df[,20]<- unlist(lapply(seq_len(n), function(x) workoutsummary(full = TRUE, hard = TRUE)))
summary.df[,21]<- unlist(lapply(seq_len(n), function(x) workoutsummary(full = TRUE, light = TRUE)))
summary.df[,22]<- unlist(lapply(seq_len(n), function(x) workoutsummary(full = TRUE, weights = TRUE)))
summary.df[,23]<- unlist(lapply(seq_len(n), function(x) workoutsummary(full = TRUE, hard = TRUE, weights = TRUE)))
summary.df[,24]<- unlist(lapply(seq_len(n), function(x) workoutsummary(full = TRUE, light = TRUE, weights = TRUE)))
